...
> 最近更新：2026-09-02（**Phase 8 tutorials：Task 1–3 完成**（contracts + domain 纯规则 + 迁移 26/pgTAP 017 disposable 验收全绿；验收期间修复 incident 联动挂错事件源等 4 处迁移真实缺陷）；Phase 7B 已完结并合并主线，生产 rollout 已完成——25 migrations / auth 200 / reviewer 已建。生产仍为 25 迁移，第 26 个上生产需另行显式授权。）
