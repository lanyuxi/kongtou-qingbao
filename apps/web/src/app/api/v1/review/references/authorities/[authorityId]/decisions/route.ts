...
import { createDomainAuthorityDecideHandler } from '../../../../../../../../lib/reference-review-handlers.js';
import { createServerSupabaseClient } from '../../../../../../../../lib/supabase-server.js';

let handler: ReturnType<typeof createDomainAuthorityDecideHandler> | undefined;

function getHandler() {
  if (handler !== undefined) return handler;
  const environment = parsePublicEnvironment();
  handler = createDomainAuthorityDecideHandler({
