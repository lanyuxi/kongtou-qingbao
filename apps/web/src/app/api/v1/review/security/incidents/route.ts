...
import { createSecurityIncidentListHandler, createSecurityIncidentOpenHandler } from '../../../../../../lib/security-review-handlers.js';
import { createServerSupabaseClient } from '../../../../../../lib/supabase-server.js';
let handlers: { get: ReturnType<typeof createSecurityIncidentListHandler>; post: ReturnType<typeof createSecurityIncidentOpenHandler> } | undefined;
function getHandlers() { if (handlers !== undefined) return handlers; const environment = parsePublicEnvironment(); const dependencies = { auth: createAuthenticatedUserVerifier(environment), reviews: createSecurityReviewRepository({ url: environment.supabaseUrl, anonKey: environment.supabaseAnonKey }), publicSecurity: createSecurityPublicRepository(createServerSupabaseClient()), ids: { generate: () => crypto.randomUUID() } }; handlers = { get: createSecurityIncidentListHandler(dependencies), post: createSecurityIncidentOpenHandler(dependencies) }; return handlers; }
