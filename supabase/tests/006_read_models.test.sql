...
select results_eq(
  ...
  $expected_policies$
    ...
    from (
      ...
      ('identity_command_receipts'::text, 'identity_command_receipts_owner'::text),
      ('profiles'::text, 'profiles_select_authenticated'::text),
      ('profiles'::text, 'profiles_select_owner'::text),
      ('profiles'::text, 'profiles_update_authenticated'::text),
      ('profiles'::text, 'profiles_update_owner'::text),
      ...
      ('user_wallet_address_events'::text, 'wallet_address_events_owner_read'::text),
      ('user_wallet_addresses'::text, 'wallet_addresses_owner'::text),
...
select results_eq(
  ...
  $$
    ...
    from (values
      ...
      ('identity_command_receipts', 'identity_command_receipts_owner'),
